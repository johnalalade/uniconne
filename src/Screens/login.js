    ...
    axios.post('/login', user, {
      ...
      .then((res) => {
        if (res.data.id) {
          ...
          this.props.history.replace(`/home?oau=true`)
        }
        else { return }
      })
      .then((res) => { this.setState({loaded: 0})
          ...
          <Row>
            ...
            <Col md="6">
              ...
              <Form onSubmit={this.submit}>
                ...
                <input type="text" name="email" placeholder="Enter Email or Phone" onChange={this.userN} value={this.state.userName} className="form-control" />
